//
//  CommandBrowserUniversalClacker.swift
//  Universal Clacker Award - Command Browser for iOS
//
//  
//  Copyright © Extratone 2021. All rights reserved.
//
    ...
    var body: some View {
		VStack {
			...
			Image("myImage")
				...
				.frame(width: 160)
				.clipped()
				.shadow(color: Color(.secondarySystemBackground).opacity(0.26), radius: 50, x: 0, y: 4)
